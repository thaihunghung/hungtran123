					...
					-->
						<tr style="<?php #if ($this->oauth_settings['login_type'] == 1) echo "display: none;" ?>">
							...
							<td id="connectqr">
								...
								<span style="display: table-cell;padding-right: 10px;padding-bottom: 10px"><a href="https://play.google.com/store/apps/details?id=com.qh.testpay" target="_blank" class="qhtp-hidden" id="qhtpapp"><img src="<?php echo plugins_url('assets/playstore-btn.png',__DIR__)?>"/></a></span><span style="display: table-cell; vertical-align: middle;display: none"><?php #echo __('Download mobile app to connect your website','qh-testpay')?></span></div>
								<?php #} ?>
